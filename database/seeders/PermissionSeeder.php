...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::create(['name' => 'contact.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'guide.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'guide_category.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'property.export'])->assignRole('Admin', 'Agent');
        ...
        Permission::create(['name' => 'standard.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'value.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'area.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'district.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'oauth.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'permission.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'role.export'])->assignRole('Admin');
        ...
        Permission::create(['name' => 'user.export'])->assignRole('Admin');
    }
}
