...
'errors.maintenance','errors.minimal','excel.contact','livewire.cms.contact.detail','livewire.cms.contact.index',
'livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.login.index',
'livewire.home.index','livewire.modal.language','livewire.modal.theme','livewire::bootstrap','livewire::simple-bootstrap',
...
'vendor.pagination.tailwind','vendors.autonumeric','vendors.bootstrap','vendors.canvas2image','vendors.clarity-microsoft-tag',
'vendors.flatpickr','vendors.font-awesome','vendors.html5-qrcode','vendors.jquery','vendors.lozad',
'vendors.pace','vendors.panzoom','vendors.select2','vendors.snowflakes','vendors.sweetalert2',
'vendors.swiper','welcome','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma',
...
'validation.custom.attribute-name.rule-name','field.#','field.action','field.company','field.confirm_password',
'field.confirm_reset','field.contact','field.created_at','field.email','field.end_date',
'field.id','field.name','field.new_password','field.password','field.phone',
'field.printed_at','field.remember_me','field.search','field.start_date','field.updated_at',
'field.user','field.username','field.created_by','field.updated_by','footer.copyright',
...
'index.delete','index.detail','index.edit','index.enter_to_search','index.export',
...
'index.data','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid',
'message.username_or_email_or_phone_is_invalid','message.no_data_available','message.you_have_successfully_logged_out','message.you_have_successfully_logged_in','message.has_been_successfully_synced',
'message.has_been_successfully_export','page.login','page.forgot_password','page.report','page.module',
'page.home','page.contact','page.property','page.article','page.permission',
'page.role','page.user','pagination.showing','pagination.results','pagination.of',
...
'validation.attributes.guard_name','validation.attributes.permission_ids','language.language','message.not_authorized_title','message.not_authorized_subtitle',
