...
'errors.maintenance','errors.minimal','excel.contact','excel.permission','excel.property',
'excel.role','excel.user','livewire.cms.contact.add','livewire.cms.contact.detail','livewire.cms.contact.edit',
'livewire.cms.contact.index','livewire.cms.district.add','livewire.cms.district.detail','livewire.cms.district.edit','livewire.cms.district.index',
...
'livewire.cms.login.index','livewire.cms.permission.add','livewire.cms.permission.detail','livewire.cms.permission.edit','livewire.cms.permission.index',
'livewire.cms.property.add','livewire.cms.property.detail','livewire.cms.property.edit','livewire.cms.property.index','livewire.cms.role.add',
'livewire.cms.role.detail','livewire.cms.role.edit','livewire.cms.role.index','livewire.cms.user.add','livewire.cms.user.detail',
'livewire.cms.user.edit','livewire.cms.user.index','livewire.components.home.form','livewire.components.home.hero','livewire.home.index',
'livewire.layouts.header','livewire.modal.account','livewire.modal.language','livewire.modal.theme','livewire::bootstrap',
...
'vendors.sweetalert2','vendors.swiper','vendors.tom-select','welcome','breadcrumbs::bootstrap4',
