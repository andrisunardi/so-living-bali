...
'cms.property.index','cms.role.index','cms.role.add','cms.role.edit','cms.role.detail',
...
'errors.maintenance','errors.minimal','excel.contact','excel.role','excel.user',
'livewire.cms.contact.add','livewire.cms.contact.detail','livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.forgot-password.index',
'livewire.cms.home.index','livewire.cms.layouts.error','livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.login.index',
...
'field.role','field.roles','field.permission','field.permissions','field.join_date',
'field.image','field.logo','field.is_active','field.role_id','field.active',
'field.guard_name','field.permission_id','field.index','footer.copyright','footer.all_rights_reserved',
'footer.created_and_designed_by','greeting.good_morning','greeting.good_afternoon','greeting.good_evening','greeting.good_night',
'helper.minlength','helper.maxlength','helper.length','helper.characters','helper.unique',
'helper.default','helper.contact.code.add','helper.contact.code.edit','index.add','index.all',
...
'index.save','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid',
'message.username_or_email_or_phone_is_invalid','message.no_data_available','message.you_have_successfully_logged_out','message.you_have_successfully_logged_in','message.has_been_successfully_added',
...
'page.access','page.home','page.contact','page.property','page.article',
...
'theme.light','theme.dark','theme.auto','validation.attributes.code','validation.attributes.company',
...
'validation.attributes.permission_ids','validation.attributes.phone','validation.attributes.role_ids','validation.attributes.username','language.language',
