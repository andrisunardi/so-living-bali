...
'cms.property.add','cms.property.edit','cms.property.detail','cms.area.index','cms.area.add',
...
'cms.user.add','cms.user.edit','cms.user.detail','cms.logout',
'storage.local',);
...
'excel.permission','excel.property','excel.role','excel.user','livewire.cms.area.add',
'livewire.cms.area.detail','livewire.cms.area.edit','livewire.cms.area.index','livewire.cms.contact.add','livewire.cms.contact.detail',
...
'index.save','index.banner','index.select','index.today','index.index',
'message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid','message.username_or_email_or_phone_is_invalid','message.no_data_available',
...
'page.role','page.user','page.account','page.logout','pagination.showing',
...
'validation.attributes.company','validation.attributes.design_driven_property','validation.attributes.electricity','validation.attributes.email','validation.attributes.ensuite_bathrooms',
...
'validation.attributes.internet_speedtest','validation.attributes.is_show','validation.attributes.is_active','validation.attributes.land_size','validation.attributes.latitude',
...
'validation.attributes.price_range','validation.attributes.property_type','validation.attributes.quiet_access_road','validation.attributes.rental_type','validation.attributes.role_ids',
...
'validation.attributes.user_id','validation.attributes.living_area_has_natural_light','validation.attributes.district_id','validation.attributes.index','language.language',
'message.not_authorized_title','message.not_authorized_subtitle','message.not_authorized_description','message.you_have_already_registered','message.the_location_you_selected_is_out_of_quota',
'message.please_select_one_location','message.please_try_again_later','message.registration_has_been_canceled','message.re_registration_has_been_successfully','message.are_you_sure_to_cancel_this_registration',
'page.location','page.registration','page.not_authorized',);
