...
'livewire.cms.layouts.header','livewire.cms.login.index','livewire.home.index','livewire.modal.account','livewire.modal.language',
'livewire.modal.theme','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
...
'vendors.select2','vendors.snowflakes','vendors.sweetalert2','vendors.swiper','welcome',
'breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize',
...
'field.roles','field.join_date','field.image','field.index','footer.copyright',
...
'greeting.good_night','index.add','index.all','index.back_to','index.back',
'index.delete','index.detail','index.edit','index.enter_to_search','index.ex',
'index.export','index.failed','index.forgot_password','index.language','index.login',
'index.logo','index.logout','index.reset_filter','index.submit','index.success',
'index.search','index.data','index.reset','index.image','index.index',
...
'validation.attributes.code','validation.attributes.company','language.language','message.not_authorized_title','message.not_authorized_subtitle',
