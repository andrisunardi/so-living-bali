...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.aliases.PropertyPriceFlexibility' => 'string',
...
'app.aliases.PropertyPowerBackup','app.aliases.PropertyPriceFlexibility','app.aliases.PropertyRentalType','app.aliases.PropertyStatus','app.aliases.PropertyTargetProfile',
...
'greeting.good_night','helper.min','helper.max','helper.minlength','helper.maxlength',
...
'index.change_active','index.total','index.save','index.banner','index.select',
'index.today','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid',
'message.username_or_email_or_phone_is_invalid','message.no_data_available','message.you_already_login','message.you_have_successfully_logged_out','message.you_have_successfully_logged_in',
...
'page.contact','page.property','page.article','page.permission','page.role',
'page.user','page.account','page.logout','pagination.showing','pagination.results',
...
'property.district_area','property.size_and_surfaces','property.land_size','property.building_size','property.number_of_floors',
...
'property.environment_and_tranquillity','property.not_directly_exposed_to_main_road','property.no_festive_venue_nearby','property.no_ongoing_or_imminent_construction','property.quiet_access_road_or_gang',
...
'property.water_source','property.electricty','property.category_assessment','property.eligible_for_upper','property.eligible_for_premium',
...
'theme.auto','validation.attributes.address','validation.attributes.code','validation.attributes.company','validation.attributes.email',
'validation.attributes.guard_name','validation.attributes.is_active','validation.attributes.name','validation.attributes.password','validation.attributes.permission_ids',
'validation.attributes.phone','validation.attributes.role_ids','validation.attributes.username','validation.attributes.area','validation.attributes.when',
'validation.attributes.bedroom','validation.attributes.property_type','validation.attributes.price_range','validation.attributes.availability_date','validation.attributes.index',
'language.language','message.not_authorized_title','message.not_authorized_subtitle','message.not_authorized_description','message.you_have_already_registered',
'message.the_location_you_selected_is_out_of_quota','message.please_select_one_location','message.please_try_again_later','message.registration_has_been_canceled','message.re_registration_has_been_successfully',
'message.are_you_sure_to_cancel_this_registration','page.location','page.registration','page.not_authorized',);
