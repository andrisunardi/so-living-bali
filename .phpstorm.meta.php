...
'livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.layouts.error',
'livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.login.index','livewire.home.index','livewire.modal.account',
'livewire.modal.language','livewire.modal.theme','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind',
...
'welcome','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6',
...
'field.roles','field.join_date','field.image','field.logo','field.index',
...
'message.no_data_available','message.you_have_successfully_logged_out','message.you_have_successfully_logged_in','message.has_been_successfully_added','message.has_been_successfully_edited',
'message.has_been_successfully_deleted','message.has_been_successfully_exported','message.has_been_successfully_synced','page.previous_page','page.login',
'page.forgot_password','page.report','page.module','page.home','page.contact',
'page.property','page.article','page.permission','page.role','page.user',
'page.account','page.logout','pagination.showing','pagination.results','pagination.of',
'pagination.to','theme.theme','theme.light','theme.dark','theme.auto',
'validation.attributes.username','validation.attributes.password','validation.attributes.email','validation.attributes.phone','validation.attributes.name',
'validation.attributes.guard_name','validation.attributes.permission_ids','validation.attributes.code','validation.attributes.company','language.language',
