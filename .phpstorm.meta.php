...
'cms.property.add','cms.property.edit','cms.property.detail','cms.permission.index','cms.permission.add',
...
'field.code','field.company','field.confirm_password','field.confirm_reset','field.contact',
'field.created_at','field.created_by','field.email','field.end_date','field.guard_name',
'field.id','field.image','field.is_active','field.join_date','field.logo',
...
'field.role','field.roles','field.search','field.start_date','field.updated_at',
'field.updated_by','field.user','field.username','field.type','field.bedroom',
'field.agent','field.status','field.user_id','field.index','footer.copyright',
...
'index.back_to','index.back','index.delete','index.detail','index.edit',
'index.enter_to_search','index.ex','index.export','index.failed','index.forgot_password',
'index.language','index.login','index.logo','index.logout','index.reset_filter',
'index.submit','index.success','index.search','index.data','index.reset',
'index.image','index.yes','index.no','index.change_active','index.total',
...
'page.article','page.permission','page.role','page.user','page.account',
...
'property.minimum_rental_duration','property.owner_price_flexibility','property.price_coherent_with_upper_or_premium_positioning','property.environment_and_tranquillity','property.not_directly_exposed_to_main_road',
...
'validation.attributes.building_size','validation.attributes.code','validation.attributes.company','validation.attributes.design_driven_property','validation.attributes.electricity',
...
'validation.attributes.guest_toilet','validation.attributes.image','validation.attributes.internet_speedtest','validation.attributes.is_active','validation.attributes.land_size',
...
'validation.attributes.when','validation.attributes.user_id','validation.attributes.living_area_has_natural_light','validation.attributes.index','language.language',
