...
'cms.property.add','cms.property.edit','cms.property.detail','cms.role.index','cms.role.add',
'cms.role.edit','cms.role.detail','cms.user.index','cms.user.add','cms.user.edit',
'cms.user.detail','cms.logout','storage.local',);
...
'errors.maintenance','errors.minimal','excel.contact','excel.property','excel.role',
'excel.user','livewire.cms.contact.add','livewire.cms.contact.detail','livewire.cms.contact.edit','livewire.cms.contact.index',
...
'livewire.cms.login.index','livewire.cms.property.add','livewire.cms.property.detail','livewire.cms.property.edit','livewire.cms.property.index',
...
'greeting.good_afternoon','greeting.good_evening','greeting.good_night','helper.minlength','helper.maxlength',
...
'index.change_active','index.total','index.save','index.banner','index.index',
...
'pagination.showing','pagination.results','pagination.of','pagination.to','theme.theme',
'theme.light','theme.dark','theme.auto','validation.attributes.address','validation.attributes.code',
'validation.attributes.company','validation.attributes.email','validation.attributes.guard_name','validation.attributes.is_active','validation.attributes.name',
'validation.attributes.password','validation.attributes.permission_ids','validation.attributes.phone','validation.attributes.role_ids','validation.attributes.username',
'validation.attributes.area','validation.attributes.when','validation.attributes.bedroom','validation.attributes.property_type','validation.attributes.price_range',
