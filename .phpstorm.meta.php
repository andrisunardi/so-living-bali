...
'constants.ghl.location_id','constants.ghl.version','constants.folder_id.property','constants.folder_id.user','constants.color',
...
'04a4981dc875be0db2d9576a1a72dd7e::contact.form','04a4981dc875be0db2d9576a1a72dd7e::contact.header','04a4981dc875be0db2d9576a1a72dd7e::contact.info','04a4981dc875be0db2d9576a1a72dd7e::contact.maps','04a4981dc875be0db2d9576a1a72dd7e::home.form',
'04a4981dc875be0db2d9576a1a72dd7e::home.hero','04a4981dc875be0db2d9576a1a72dd7e::home.our-concept','04a4981dc875be0db2d9576a1a72dd7e::meta','04a4981dc875be0db2d9576a1a72dd7e::modal.search-menu','04a4981dc875be0db2d9576a1a72dd7e::navigation',
'04a4981dc875be0db2d9576a1a72dd7e::network','04a4981dc875be0db2d9576a1a72dd7e::pagination','04a4981dc875be0db2d9576a1a72dd7e::profile','04a4981dc875be0db2d9576a1a72dd7e::vendors','activity-log',
...
'af6a29d55d306249cfe5b80ece79872b::cms.area.index','af6a29d55d306249cfe5b80ece79872b::cms.concept.add','af6a29d55d306249cfe5b80ece79872b::cms.concept.detail','af6a29d55d306249cfe5b80ece79872b::cms.concept.edit','af6a29d55d306249cfe5b80ece79872b::cms.concept.index',
...
'components.contact.form','components.contact.header','components.contact.info','components.contact.maps','components.home.form',
'components.home.hero','components.home.our-concept','components.meta','components.modal.search-menu','components.navigation',
...
'excel.concept','excel.contact','excel.district','excel.oauth','excel.permission',
'excel.property','excel.property-image','excel.role','excel.user','f4ac99e09542ff494432bc959d4fee61::app',
...
'home.our-concept','layouts.app','layouts.breadcrumbs','layouts.cms.error','layouts.cms.footer',
...
'pages.cms.concept.add','pages.cms.concept.detail','pages.cms.concept.edit','pages.cms.concept.index','pages.cms.contact.add',
'pages.cms.contact.detail','pages.cms.contact.edit','pages.cms.contact.index','pages.cms.district.add','pages.cms.district.detail',
'pages.cms.district.edit','pages.cms.district.index','pages.cms.forgot-password.index','pages.cms.home.index','pages.cms.login.index',
...
'validation.custom.attribute-name.rule-name','contact.info.title','contact.info.description','contact.info.contact','contact.form.success.title',
'contact.form.success.body','contact.form.failed.title','contact.form.label.first_name','contact.form.label.last_name','contact.form.label.email',
'contact.form.label.phone','contact.form.label.area','contact.form.label.bedroom','contact.form.label.rental_type','contact.form.label.message',
...
'contact.form.placeholder.rental_type','contact.form.placeholder.message','contact.form.submit','field.#','field.action',
'field.active','field.address','field.agent','field.bedroom','field.code',
'field.company','field.confirm_password','field.confirm_reset','field.contact','field.created_at',
'field.created_by','field.district_id','field.area_id','field.email','field.end_date',
'field.guard_name','field.id','field.image','field.is_active','field.is_show',
...
'field.show','field.start_date','field.status','field.type','field.updated_at',
'field.updated_by','field.user_id','field.user','field.username','field.date',
'field.property_id','field.description','field.image_url','field.refresh_token','field.access_token',
'field.token_type','field.expires_in','field.scope','field.created','field.title',
'field.title_id','field.title_zh','field.description_id','field.description_zh','field.icon',
'field.attribute','field.rental_type','field.message','field.first_name','field.last_name',
...
'index.connect','index.currency','index.list_your_properties','index.search_menu','index.area',
'index.office_location','index.bedroom','index.rental_type','index.contact','index.message',
...
'page.article','page.master','page.concept','page.area','page.district',
...
'validation.attributes.created','validation.attributes.design_driven_property','validation.attributes.district_id','validation.attributes.electricity','validation.attributes.email',
'validation.attributes.end_date','validation.attributes.ensuite_bathrooms','validation.attributes.expires_in','validation.attributes.full_legal_documentation','validation.attributes.fully_furnished',
...
'validation.attributes.start_date','validation.attributes.status','validation.attributes.storage','validation.attributes.target_profile','validation.attributes.token_type',
...
'validation.attributes.visit_date','validation.attributes.water_source','validation.attributes.when','validation.attributes.internet_speedtest_image','validation.attributes.title',
'validation.attributes.title_id','validation.attributes.title_zh','validation.attributes.description','validation.attributes.description_id','validation.attributes.description_zh',
'validation.attributes.icon','validation.attributes.first_name','validation.attributes.last_name','validation.attributes.message','validation.attributes.index',
'language.language',);
