...
'property.utilities_and_technical','property.internet_speedtest','property.power_backup','property.water_source','property.electricty',
...
'validation.attributes.code','validation.attributes.company','validation.attributes.email','validation.attributes.guard_name','validation.attributes.is_active',
'validation.attributes.name','validation.attributes.password','validation.attributes.permission_ids','validation.attributes.phone','validation.attributes.role_ids',
'validation.attributes.username','validation.attributes.area','validation.attributes.when','validation.attributes.bedroom','validation.attributes.property_type',
'validation.attributes.price_range','validation.attributes.availability_date','validation.attributes.image','validation.attributes.latitude','validation.attributes.longitude',
'validation.attributes.visit_date','validation.attributes.land_size','validation.attributes.building_size','validation.attributes.number_of_floors','validation.attributes.outdoor_area_size',
'validation.attributes.pool_size','validation.attributes.number_of_bathrooms','validation.attributes.index','language.language','message.not_authorized_title',
...
'message.please_try_again_later','message.registration_has_been_canceled','message.re_registration_has_been_successfully','message.are_you_sure_to_cancel_this_registration','page.location',
'page.registration','page.not_authorized',);
