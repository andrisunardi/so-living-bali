...
'session.secure','session.http_only','session.same_site','session.partitioned','sitemap.guzzle_options.cookies',
...
'sitemap.crawl_profile','social-medias.0.id','social-medias.0.name','social-medias.0.icon','social-medias.0.username',
...
'property.index','property.detail','contact','cms.login','cms.forgot-password',
...
'section.whatsapp','service.overview','service.⚡our-services','service.⚡our-standard','sitemap::image',
'sitemap::news','sitemap::sitemap','sitemap::sitemapIndex.index','sitemap::sitemapIndex.sitemap','sitemap::url',
'sitemap::video','third-party','third-party.facebook','third-party.google-analytics','vendor.breadcrumbs.bootstrap4',
...
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','vendor.sitemap.image','vendor.sitemap.news','vendor.sitemap.sitemap',
'vendor.sitemap.sitemapIndex.index','vendor.sitemap.sitemapIndex.sitemap','vendor.sitemap.url','vendor.sitemap.video','vendors',
...
'vendors.trix','⚡activity-log','⚡navigation','⚡network','⚡profile',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','pretty-routes::routes','sitemap::image',
'sitemap::news','sitemap::sitemap','sitemap::sitemapIndex.index','sitemap::sitemapIndex.sitemap','sitemap::url',
'sitemap::video','telescope::layout',);
