...
'af6a29d55d306249cfe5b80ece79872b::cms-old.permission.edit','af6a29d55d306249cfe5b80ece79872b::cms-old.permission.index','af6a29d55d306249cfe5b80ece79872b::cms-old.property.edit','af6a29d55d306249cfe5b80ece79872b::cms-old.role.add','af6a29d55d306249cfe5b80ece79872b::cms-old.role.detail',
'af6a29d55d306249cfe5b80ece79872b::cms-old.role.edit','af6a29d55d306249cfe5b80ece79872b::cms.forgot-password.index','af6a29d55d306249cfe5b80ece79872b::cms.home.index','af6a29d55d306249cfe5b80ece79872b::cms.login.index','af6a29d55d306249cfe5b80ece79872b::cms.logout.index',
...
'af6a29d55d306249cfe5b80ece79872b::cms.profile.change-password','af6a29d55d306249cfe5b80ece79872b::cms.profile.edit-profile','af6a29d55d306249cfe5b80ece79872b::cms.profile.index','af6a29d55d306249cfe5b80ece79872b::cms.profile.setting','af6a29d55d306249cfe5b80ece79872b::cms.property.add',
...
'pages.cms-old.permission.edit','pages.cms-old.permission.index','pages.cms-old.property.edit','pages.cms-old.role.add','pages.cms-old.role.detail',
'pages.cms-old.role.edit','pages.cms.forgot-password.index','pages.cms.home.index','pages.cms.login.index','pages.cms.logout.index',
...
'pages.cms.profile.change-password','pages.cms.profile.edit-profile','pages.cms.profile.index','pages.cms.profile.setting','pages.cms.property.add',
...
'field.user','field.username','field.index','footer.copyright','footer.all_rights_reserved',
...
'home.form.bedroom','home.form.type','home.form.price_range','index.add','index.all',
'index.back_to','index.back','index.banner','index.change_active','index.change_language',
'index.change_show','index.data','index.delete','index.detail','index.edit',
'index.enter_to_search','index.ex','index.export','index.failed','index.forgot_password',
'index.image','index.language','index.login','index.logo','index.logout',
'index.no','index.printed_date','index.reset_filter','index.reset','index.save',
'index.search','index.select','index.submit','index.success','index.today',
'index.total','index.yes','index.navigation_menu','index.profile_menu','index.generate',
...
'message.has_been_successfully_synced','page.home','page.service','page.about','page.previous_page',
'page.login','page.forgot_password','page.report','page.module','page.access',
'page.contact','page.property','page.article','page.master','page.area',
'page.district','page.permission','page.role','page.user','page.profile',
...
'validation.attributes.code','validation.attributes.company','validation.attributes.confirm_reset','validation.attributes.design_driven_property','validation.attributes.district_id',
'validation.attributes.electricity','validation.attributes.email','validation.attributes.ensuite_bathrooms','validation.attributes.full_legal_documentation','validation.attributes.fully_furnished',
'validation.attributes.guard_name','validation.attributes.guest_toilet','validation.attributes.image','validation.attributes.internet_speedtest','validation.attributes.is_active',
'validation.attributes.is_show','validation.attributes.land_size','validation.attributes.latitude','validation.attributes.living_area_has_natural_light','validation.attributes.living_area',
'validation.attributes.living_style','validation.attributes.longitude','validation.attributes.minimum_rental_duration_months','validation.attributes.name','validation.attributes.no_festive_venue_nearby',
...
'validation.attributes.orientation','validation.attributes.outdoor_area_size','validation.attributes.owner_price_flexibility','validation.attributes.password','validation.attributes.permission_ids',
...
'validation.attributes.property_type','validation.attributes.quiet_access_road','validation.attributes.remember_me','validation.attributes.rental_type','validation.attributes.role_ids',
'validation.attributes.status','validation.attributes.storage','validation.attributes.target_profile','validation.attributes.trade_off_identified','validation.attributes.usability_limitations',
...
'validation.attributes.when','validation.attributes.role_id','validation.attributes.permission_id','validation.attributes.start_date','validation.attributes.end_date',
'validation.attributes.area_id','validation.attributes.index','language.language','page.account',);
