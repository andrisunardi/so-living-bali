...
'constants.ghl.location_id','constants.folder_id.property','constants.color','database.default','database.connections.sqlite.driver',
...
'filesystems.disks.google.refreshToken','filesystems.disks.google.folder','filesystems.links./Users/andrisunardi/project/long-stay-bali/public/storage','flare.key','flare.flare_middleware',
...
'index.image_temporary_url','index.connect','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password',
...
'message.has_been_successfully_changed','message.has_been_successfully_exported','message.has_been_successfully_synced','message.has_been_successfully_connected','page.home',
...
'page.property_image','page.article','page.master','page.area','page.district',
...
'validation.attributes.visit_date','validation.attributes.water_source','validation.attributes.when','validation.attributes.internet_speedtest_image','validation.attributes.index',
'language.language',);
...
'GHL_CLIENT_SECRET','GHL_REDIRECT_URI','GHL_USER_TYPE','GHL_LOCATION_ID','GOOGLE_CLIENT_ID',
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','GOOGLE_DRIVE_ROOT_FOLDER','FOLDER_ID_PROPERTY',);
