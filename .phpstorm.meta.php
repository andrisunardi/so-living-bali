...
'constants.slack.sms','constants.slack.mail','constants.slack.channel','constants.ghl.url','constants.ghl.client_id',
'constants.ghl.client_secret','constants.ghl.grant_type','constants.ghl.redirect_uri','constants.ghl.user_type','constants.color',
...
'livewire.smart_wire_keys','livewire.pagination_theme','livewire.release_token','livewire-alert.position','livewire-alert.timer',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','pretty-routes.url','pretty-routes.middlewares',
...
'errors.maintenance','errors.minimal','excel.contact','livewire.cms.contact.add','livewire.cms.contact.detail',
'livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.layouts.footer',
'livewire.cms.layouts.header','livewire.cms.login.index','livewire.home.index','livewire.modal.language','livewire.modal.theme',
...
'validation.custom.attribute-name.rule-name','field.#','field.action','field.code','field.company',
'field.confirm_password','field.confirm_reset','field.contact','field.created_at','field.email',
'field.end_date','field.id','field.name','field.new_password','field.password',
'field.phone','field.printed_at','field.remember_me','field.search','field.start_date',
'field.updated_at','field.user','field.username','field.created_by','field.updated_by',
'footer.copyright','footer.all_rights_reserved','footer.created_and_designed_by','greeting.good_morning','greeting.good_afternoon',
'greeting.good_evening','greeting.good_night','index.add','index.all','index.back_to',
...
'index.success','index.search','index.data','index.reset','index.index',
...
'message.has_been_successfully_exported','message.has_been_successfully_synced','page.login','page.forgot_password','page.report',
'page.module','page.home','page.contact','page.property','page.article',
'page.permission','page.role','page.user','pagination.showing','pagination.results',
'pagination.of','pagination.to','theme.theme','theme.light','theme.dark',
'theme.auto','validation.attributes.username','validation.attributes.password','validation.attributes.email','validation.attributes.phone',
'validation.attributes.name','validation.attributes.guard_name','validation.attributes.permission_ids','validation.attributes.code','validation.attributes.company',
...
'LOG_SLACK_WEBHOOK_URL','GHL_URL','GHL_CLIENT_ID','GHL_CLIENT_SECRET','GHL_GRANT_TYPE',
'GHL_REDIRECT_URI','GHL_USER_TYPE',);
