...
'app.aliases.PropertyBedroom','app.aliases.PropertyType','app.aliases.Excel','app.aliases.Menu','app.aliases.PDF',
...
'field.updated_by','field.user','field.username','field.type','field.index',
'footer.copyright','footer.all_rights_reserved','footer.created_and_designed_by','greeting.good_morning','greeting.good_afternoon',
'greeting.good_evening','greeting.good_night','helper.minlength','helper.maxlength','helper.length',
'helper.characters','helper.unique','helper.default','helper.contact.code.add','helper.contact.code.edit',
'home.hero.title','home.hero.description','home.form.title','home.form.button','home.form.area',
'home.form.when','home.form.bedrooms','home.form.property_type','home.form.price_range','index.add',
'index.all','index.back_to','index.back','index.delete','index.detail',
'index.edit','index.enter_to_search','index.ex','index.export','index.failed',
'index.forgot_password','index.language','index.login','index.logo','index.logout',
'index.reset_filter','index.submit','index.success','index.search','index.data',
'index.reset','index.image','index.yes','index.no','index.change_active',
'index.total','index.save','index.banner','index.index','message.please_login_with_your_account_to_continue',
'message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid','message.username_or_email_or_phone_is_invalid','message.no_data_available','message.you_have_successfully_logged_out',
...
'validation.attributes.when','validation.attributes.bedrooms','validation.attributes.property_type','validation.attributes.price_range','language.language',
