...
'cms.property.index','cms.user.index','cms.user.add','cms.user.edit','cms.user.detail',
...
'errors.maintenance','errors.minimal','excel.contact','excel.user','livewire.cms.contact.add',
'livewire.cms.contact.detail','livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.forgot-password.index','livewire.cms.home.index',
'livewire.cms.layouts.error','livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.login.index','livewire.cms.user.add',
...
'field.role','field.roles','field.join_date','field.image','field.logo',
'field.is_active','field.role_id','field.active','field.index','footer.copyright',
...
'helper.unique','helper.contact.code.add','helper.contact.code.edit','index.add','index.all',
...
'index.image','index.yes','index.no','index.change_active','index.index',
...
'message.has_been_successfully_changed','message.has_been_successfully_exported','message.has_been_successfully_synced','page.previous_page','page.login',
'page.forgot_password','page.report','page.module','page.access','page.home',
...
'theme.auto','validation.attributes.code','validation.attributes.company','validation.attributes.email','validation.attributes.guard_name',
'validation.attributes.is_active','validation.attributes.name','validation.attributes.password','validation.attributes.permission_ids','validation.attributes.phone',
'validation.attributes.role_ids','validation.attributes.username','language.language','message.not_authorized_title','message.not_authorized_subtitle',
