...
'contact.form.label.phone','contact.form.label.area','contact.form.label.bedroom','contact.form.label.type','contact.form.label.message',
...
'contact.form.placeholder.type','contact.form.placeholder.message','contact.form.submit','field.#','field.action',
...
'field.index','footer.copyright','footer.all_rights_reserved','footer.created_and_designed_by','greeting.good_morning',
...
'home.form.price_range','home.our_concept.sub_title','home.our_concept.title','home.our_concept.description','index.access',
'index.add','index.all','index.availability','index.back_to','index.back',
'index.banner','index.change_active','index.change_language','index.change_show','index.close',
...
'index.login','index.logo','index.logout','index.navigation_menu','index.no',
'index.open','index.printed_date','index.profile_menu','index.refresh','index.reset_filter',
'index.reset','index.save','index.search','index.select','index.submit',
'index.success','index.today','index.token','index.total','index.visit',
'index.yes','index.image_temporary_url','index.connect','index.currency','index.list_your_properties',
'index.search_menu','index.area','index.office_location','index.bedroom','index.rental_type',
'index.contact','index.message','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password',
...
'validation.attributes.internet_speedtest_image','validation.attributes.title','validation.attributes.title_id','validation.attributes.title_zh','validation.attributes.description',
'validation.attributes.description_id','validation.attributes.description_zh','validation.attributes.icon','validation.attributes.first_name','validation.attributes.last_name',
'validation.attributes.message','validation.attributes.index','language.language',);
