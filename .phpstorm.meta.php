...
'app.aliases.permission','app.aliases.QrCode','app.aliases.role_or_permission','app.aliases.role','auth.defaults.guard',
...
'constants.contact.whatsapp','constants.contact.email','constants.ghl.app_url','constants.ghl.oauth_url','constants.ghl.client_id',
...
'filesystems.disks.s3.report','filesystems.links./Users/andrisunardi/project/long-stay-bali/public/storage','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs',
...
'livewire.inject_morph_markers','livewire.smart_wire_keys','livewire.pagination_theme','livewire.release_token','livewire-alert.position',
...
'locale','home','about','service','article',
'contact','cms.login','cms.forgot-password','cms.home','cms.contact.index',
'cms.contact.add','cms.contact.edit','cms.contact.detail','cms.article.index','cms.property.index',
'cms.property.add','cms.property.edit','cms.property.detail','cms.district.index','cms.district.add',
...
'cms.user.index','cms.user.add','cms.user.edit','cms.user.detail','cms.logout','storage.local',);
...
'errors.maintenance','errors.minimal','excel.contact','excel.district','excel.permission',
'excel.property','excel.role','excel.user','livewire.cms.contact.add','livewire.cms.contact.detail',
'livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.district.add','livewire.cms.district.detail','livewire.cms.district.edit',
'livewire.cms.district.index','livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.layouts.error','livewire.cms.layouts.footer',
'livewire.cms.layouts.header','livewire.cms.login.index','livewire.cms.permission.add','livewire.cms.permission.detail','livewire.cms.permission.edit',
'livewire.cms.permission.index','livewire.cms.property.add','livewire.cms.property.detail','livewire.cms.property.edit','livewire.cms.property.index',
'livewire.cms.role.add','livewire.cms.role.detail','livewire.cms.role.edit','livewire.cms.role.index','livewire.cms.user.add',
'livewire.cms.user.detail','livewire.cms.user.edit','livewire.cms.user.index','livewire.components.home.form','livewire.components.home.hero',
'livewire.home.index','livewire.layouts.header','livewire.modal.account','livewire.modal.language','livewire.modal.theme',
...
'vendors.snowflakes','vendors.sweetalert2','vendors.swiper','vendors.tom-select','welcome',
'breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize',
...
'helper.length','helper.characters','helper.unique','helper.default','helper.contact.code.add',
'helper.contact.code.edit','home.hero.title','home.hero.description','home.form.title','home.form.button',
'home.form.area','home.form.when','home.form.bedroom','home.form.type','home.form.price_range',
'index.add','index.all','index.back_to','index.back','index.delete',
'index.detail','index.edit','index.enter_to_search','index.ex','index.export',
'index.failed','index.forgot_password','index.language','index.login','index.logo',
'index.logout','index.reset_filter','index.submit','index.success','index.search',
'index.data','index.reset','index.image','index.yes','index.no',
'index.change_show','index.change_active','index.total','index.save','index.banner',
'index.select','index.today','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password',
'message.username_or_password_is_invalid','message.username_or_email_or_phone_is_invalid','message.no_data_available','message.you_already_login','message.you_have_successfully_logged_out',
...
'page.account','page.logout','pagination.showing','pagination.results','pagination.of',
...
'validation.attributes.bedroom','validation.attributes.building_size','validation.attributes.code','validation.attributes.company','validation.attributes.design_driven_property',
...
'validation.attributes.guard_name','validation.attributes.guest_toilet','validation.attributes.image','validation.attributes.internet_speedtest','validation.attributes.is_show',
'validation.attributes.is_active','validation.attributes.land_size','validation.attributes.latitude','validation.attributes.living_area','validation.attributes.living_style',
...
'validation.attributes.quiet_access_road','validation.attributes.rental_type','validation.attributes.role_ids','validation.attributes.status','validation.attributes.storage',
'validation.attributes.target_profile','validation.attributes.trade_off_identified','validation.attributes.usability_limitations','validation.attributes.username','validation.attributes.view',
'validation.attributes.visit_date','validation.attributes.water_source','validation.attributes.when','validation.attributes.user_id','validation.attributes.living_area_has_natural_light',
'validation.attributes.index','language.language','message.not_authorized_title','message.not_authorized_subtitle','message.not_authorized_description',
'message.you_have_already_registered','message.the_location_you_selected_is_out_of_quota','message.please_select_one_location','message.please_try_again_later','message.registration_has_been_canceled',
'message.re_registration_has_been_successfully','message.are_you_sure_to_cancel_this_registration','page.location','page.registration','page.not_authorized',);
...
'LOG_SLACK_WEBHOOK_URL','CONTACT_WHATSAPP','CONTACT_EMAIL','GHL_APP_URL','GHL_OAUTH_URL',
'GHL_CLIENT_ID','GHL_CLIENT_SECRET','GHL_GRANT_TYPE','GHL_REDIRECT_URI','GHL_USER_TYPE',
'GHL_LOCATION_ID',);
