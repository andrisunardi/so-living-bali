...
'field.password','field.remember_me','field.confirm_reset','footer.copyright','footer.all_rights_reserved',
'footer.created_and_designed_by','greeting.good_morning','greeting.good_afternoon','greeting.good_evening','greeting.good_night',
'index.logo','index.all','index.back_to','index.login','index.submit',
'index.language','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid','message.no_data_available',
'message.you_have_successfully_logged_in','message.has_been_successfully_synced','message.has_been_successfully_export','page.home','page.login',
...
'validation.attributes.phone','validation.attributes.name','validation.attributes.guard_name','validation.attributes.permission_ids','index.no_data_available',
'index.copyright','index.all_rights_reserved','language.language','message.not_authorized_title','message.not_authorized_subtitle',
