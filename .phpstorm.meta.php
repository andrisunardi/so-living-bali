...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.google.clientId' => 'string',
            'filesystems.disks.google.clientSecret' => 'string',
            'filesystems.disks.google.accessToken' => 'string',
            'filesystems.disks.google.refreshToken' => 'string',
...
'filesystems.disks.google.folder','filesystems.links./Users/andrisunardi/project/long-stay-bali/public/storage','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs',
...
'af6a29d55d306249cfe5b80ece79872b::article.index','af6a29d55d306249cfe5b80ece79872b::cms-old.contact.add','af6a29d55d306249cfe5b80ece79872b::cms-old.contact.detail','af6a29d55d306249cfe5b80ece79872b::cms-old.contact.edit','af6a29d55d306249cfe5b80ece79872b::cms-old.contact.index',
'af6a29d55d306249cfe5b80ece79872b::cms.area.add','af6a29d55d306249cfe5b80ece79872b::cms.area.detail','af6a29d55d306249cfe5b80ece79872b::cms.area.edit','af6a29d55d306249cfe5b80ece79872b::cms.area.index','af6a29d55d306249cfe5b80ece79872b::cms.district.add',
...
'notifications::email','pages.about.index','pages.article.index','pages.cms-old.contact.add','pages.cms-old.contact.detail',
'pages.cms-old.contact.edit','pages.cms-old.contact.index','pages.cms.area.add','pages.cms.area.detail','pages.cms.area.edit',
'pages.cms.area.index','pages.cms.district.add','pages.cms.district.detail','pages.cms.district.edit','pages.cms.district.index',
...
'pages::cms-old.contact.add','pages::cms-old.contact.detail','pages::cms-old.contact.edit','pages::cms-old.contact.index','pages::cms.area.add',
'pages::cms.area.detail','pages::cms.area.edit','pages::cms.area.index','pages::cms.district.add','pages::cms.district.detail',
...
'field.user','field.username','field.date','field.index','footer.copyright',
...
'home.form.when','home.form.bedroom','home.form.type','home.form.price_range','index.add',
'index.all','index.back_to','index.back','index.banner','index.change_active',
'index.change_language','index.change_show','index.data','index.delete','index.detail',
'index.edit','index.enter_to_search','index.ex','index.export','index.failed',
'index.forgot_password','index.image','index.language','index.login','index.logo',
'index.logout','index.no','index.printed_date','index.reset_filter','index.reset',
'index.save','index.search','index.select','index.submit','index.success',
'index.today','index.total','index.yes','index.navigation_menu','index.profile_menu',
'index.generate','index.list_permission','index.list_user','index.list_role','index.availability',
'index.visit','index.index','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid',
...
'message.has_been_successfully_exported','message.has_been_successfully_synced','page.home','page.service','page.about',
'page.previous_page','page.login','page.forgot_password','page.report','page.module',
'page.access','page.contact','page.property','page.article','page.master',
'page.area','page.district','page.permission','page.role','page.user',
...
'property.living_style','property.legal_and_basic_eligibility','property.full_legal_documentation_available','property.fully_furnished','property.rental_type_accepted',
...
'property.usability_limitations_identified','property.trade_off_or_target_profile','property.trade_off_identified','property.if_yes_describe_briefly','property.target_profile',
...
'theme.theme','theme.light','theme.dark','theme.auto','validation.attributes.address',
...
'validation.attributes.building_size','validation.attributes.code','validation.attributes.company','validation.attributes.confirm_reset','validation.attributes.design_driven_property',
'validation.attributes.district_id','validation.attributes.electricity','validation.attributes.email','validation.attributes.ensuite_bathrooms','validation.attributes.full_legal_documentation',
'validation.attributes.fully_furnished','validation.attributes.guard_name','validation.attributes.guest_toilet','validation.attributes.image','validation.attributes.internet_speedtest',
'validation.attributes.is_active','validation.attributes.is_show','validation.attributes.land_size','validation.attributes.latitude','validation.attributes.living_area_has_natural_light',
'validation.attributes.living_area','validation.attributes.living_style','validation.attributes.longitude','validation.attributes.minimum_rental_duration_months','validation.attributes.name',
...
'validation.attributes.price_range','validation.attributes.property_type','validation.attributes.quiet_access_road','validation.attributes.remember_me','validation.attributes.rental_type',
...
'validation.attributes.water_source','validation.attributes.when','validation.attributes.role_id','validation.attributes.permission_id','validation.attributes.start_date',
'validation.attributes.end_date','validation.attributes.area_id','validation.attributes.index','language.language','page.account',);
