...
'app.aliases.Excel','app.aliases.Menu','app.aliases.PDF','app.aliases.permission','app.aliases.QrCode',
...
'constants.slack.sms','constants.slack.mail','constants.slack.channel','constants.color','database.default',
...
'database.redis.horizon.backoff_base','database.redis.horizon.backoff_cap','database.redis.horizon.options.prefix','debugbar.enabled','debugbar.hide_empty_tabs',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ignition.editor','ignition.theme',
...
'livewire.pagination_theme','livewire.release_token','livewire-alert.position','livewire-alert.timer','livewire-alert.toast',
...
'permission.cache.key','permission.cache.store','pretty-routes.url','pretty-routes.middlewares','pretty-routes.debug_only',
...
'cms.contact.index','cms.logout','storage.local',);
...
'errors.maintenance','errors.minimal','livewire.cms.contact.index','livewire.cms.forgot-password.index','livewire.cms.home.index',
'livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.login.index','livewire.home.index','livewire::bootstrap',
...
'validation.custom.attribute-name.rule-name','field.name','field.email','field.phone','field.username',
'field.password','field.new_password','field.confirm_password','field.remember_me','field.confirm_reset',
'footer.copyright','footer.all_rights_reserved','footer.created_and_designed_by','greeting.good_morning','greeting.good_afternoon',
'greeting.good_evening','greeting.good_night','index.logo','index.all','index.back_to',
'index.login','index.forgot_password','index.submit','index.language','index.failed',
'index.success','index.enter_to_search','message.please_login_with_your_account_to_continue','message.please_enter_your_data_to_get_new_password','message.username_or_password_is_invalid',
'message.username_or_email_or_phone_is_invalid','message.no_data_available','message.you_have_been_successfully_logged_out','message.you_have_successfully_logged_in','message.has_been_successfully_synced',
'message.has_been_successfully_export','page.login','page.forgot_password','page.report','page.module',
'page.home','page.contact','page.permission','page.role','page.user',
'pagination.showing','pagination.to','pagination.total','pagination.data','theme.theme',
'theme.light','theme.dark','theme.auto','validation.attributes.username','validation.attributes.password',
'validation.attributes.email','validation.attributes.phone','validation.attributes.name','validation.attributes.guard_name','validation.attributes.permission_ids',
'index.no_data_available','index.copyright','index.all_rights_reserved','language.language','message.not_authorized_title',
