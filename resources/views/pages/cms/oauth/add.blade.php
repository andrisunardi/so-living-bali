...
use App\Livewire\Forms\CMS\Oauth\OauthAddForm;
use Illuminate\Validation\ValidationException;
use Livewire\Attributes\Title;

new #[Title('Add | Oauth')] class extends Component {
    public OauthAddForm $form;
    ...
    public function submit(): void
    {
        try {
            ...
            session()->flash('success', [
                ...
                'message' => trans('page.oauth') . ' ' . trans('message.has_been_successfully_added'),
            ]);
